...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    createComment: async (
      reqCreateCommentBody?: ReqCreateCommentBody,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
    ...
    createCommentLike: async (
      createCommentLikeReqBody?: CreateCommentLikeReqBody,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
    ...
    createPostLike: async (
      createPostLikeReqBody?: CreatePostLikeReqBody,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
    ...
    deleteCommentLike: async (
      ...
      const localVarPath = `/comment-likes/comment/{CommentId}`.replace(
        `{${'CommentId'}}`,
        encodeURIComponent(String(commentId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteConnection: async (
      ...
      const localVarPath = `/follows/{connectionId}`.replace(
        `{${'connectionId'}}`,
     ...
     * @throws {RequiredError}
     */
    deletePostLike: async (
      postId: number,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'postId' is not null or undefined
      assertParamExists('deletePostLike', 'postId', postId);
      const localVarPath = `/post-likes/post/{PostId}`.replace(
        `{${'PostId'}}`,
        encodeURIComponent(String(postId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getCommentsByPostID: async (
      ...
      const localVarPath = `/comments/post/{postId}`.replace(
        `{${'postId'}}`,
        encodeURIComponent(String(postId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getPostsOfUser: async (
      ...
      const localVarPath = `/posts/user/{userId}`.replace(
        `{${'userId'}}`,
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.chatSocket(
        roomId,
        options,
      );
    ...
    async createChatRoom(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreateChatRoom201Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createChatRoom(
        createChatRoomRequest,
        options,
      );
      return createRequestFunction(
    ...
    async createCommentLike(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreateCommentLike201Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createCommentLike(
          createCommentLikeReqBody,
          options,
        );
      return createRequestFunction(
    ...
    async createPostLike(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreatePostLike201Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createPostLike(
        createPostLikeReqBody,
        options,
      );
      return createRequestFunction(
    ...
    async csrftoken(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ResCsrfToken>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.csrftoken(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteCommentLike(commentId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async deletePostLike(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deletePostLike(
        postId,
        options,
      );
      return createRequestFunction(
    ...
    async fetchBookData(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Book>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.fetchBookData(
        booksGenreId,
        keyword,
        options,
      );
     ...
     * @throws {RequiredError}
     */
    async getBooksGenres(
      options?: AxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<BookGenreNode>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBooksGenres(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getChatRooms(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getCommentsByPostID(postId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getFollowerConnections(userId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getFollowingConnections(
          userId,
          options,
        );
      return createRequestFunction(
    ...
    async getLikedCommentList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetLikedCommentList200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getLikedCommentList(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async getLikedPostList(
      options?: AxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetLikedPostList200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getLikedPostList(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getLoginUser(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getPosts(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async getPostsOfUser(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Post>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPostsOfUser(
        userId,
        options,
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.googleOauthCallback(
          state,
          code,
          options,
        );
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    createComment(
      ...
      return localVarFp
        .createComment(reqCreateCommentBody, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createCommentLike(
      ...
      return localVarFp
        .createCommentLike(createCommentLikeReqBody, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createConnection(
      ...
      return localVarFp
        .createConnection(createConnectionRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createPost(
      ...
      return localVarFp
        .createPost(content, rating, iSBNcode, image, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createPostLike(
      ...
      return localVarFp
        .createPostLike(createPostLikeReqBody, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    fetchBookData(
      ...
      keyword?: string,
      options?: any,
    ): AxiosPromise<Array<Book>> {
      return localVarFp
        .fetchBookData(booksGenreId, keyword, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getFollowerConnections(
      ...
      return localVarFp
        .getFollowerConnections(userId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getFollowingConnections(
      ...
      return localVarFp
        .getFollowingConnections(userId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getPostByPostID(postId: number, options?: any): AxiosPromise<Post> {
      return localVarFp
        .getPostByPostID(postId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    googleOauthCallback(
      ...
      return localVarFp
        .googleOauthCallback(state, code, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateUser(
      ...
      return localVarFp
        .updateUser(name, profileImage, profileText, options)
        .then((request) => request(axios, basePath));
    },
  };
};
