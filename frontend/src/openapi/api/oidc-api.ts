 ...
 * @export
 */
export const OidcApiAxiosParamCreator = function (
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.googleSignupCallback(
          state,
          code,
          options,
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.signupWithGoogle(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const OidcApiFactory = function (
  ...
  return {
    ...
    googleSignupCallback(
      ...
      return localVarFp
        .googleSignupCallback(state, code, options)
