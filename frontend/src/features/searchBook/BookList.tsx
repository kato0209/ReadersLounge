                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                      <CardContent sx={{ flex: '1 0 auto' }}>
                        <Link href={book.item_url} underline="hover">
                          <Typography component="div" sx={{ fontSize: '1.5rem', '@media (max-width: 500px)':{fontSize: '1.0rem'}}}>
                            {book.title}
                          </Typography>
                        </Link>
                        ...
                        <Box sx={{display: 'flex', alignItems: 'center'}}>
                          <Typography component="div" sx={{color: 'red', fontSize: '1.5rem', marginRight: '0.3rem'}}>
                            {book.price}円
                          </Typography>
                      ...
                      >
                       <CreatePost displayString='本の感想を投稿' book={book} formData={formData} />
                      </Box>
                    </Box>
                    <Box sx={{ 
                        width: '30%', 
